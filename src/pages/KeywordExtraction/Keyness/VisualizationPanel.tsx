/**
 * Visualization Panel for Keyness Analysis
 */
...
export default function VisualizationPanel({
  ...
  const handleExportSVG = useCallback(() => {
    ...
    link.href = url
    link.download = `keyness-${activeTab}-chart.svg`
    link.click()
        ...
        if (svgHeight > containerHeight) {
          ...
          img.onload = () => {
            ...
            canvas.toBlob((blob) => {
              ...
              const link = document.createElement('a')
              link.href = pngUrl
              link.download = `keyness-${activeTab}-chart.png`
              link.click()
  ...
  // Filter and convert data for charts
      ...
      return (
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary" textAlign="center">
            {t('keyword.visualization.runAnalysisFirst', 'Run keyness analysis first')}
          </Typography>
        </Box>
      )
    }
          ...
          <FormControlLabel
            ...
            label={
              <Typography variant="body2">
                {t('keyword.keyness.positiveOnly', 'Positive only')}
              </Typography>
            }
          />
