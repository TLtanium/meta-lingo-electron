    ...
    >
      ...
      <AccordionDetails>
            ...
            <FormControlLabel
              ...
              label={
                <Typography variant="body2">
                  {t('wordFrequency.posFilter.keepMode')}
                </Typography>
              }
            />
            <FormControlLabel
              ...
              label={
                <Typography variant="body2">
                  {t('wordFrequency.posFilter.filterMode')}
                </Typography>
              }
            />
          </RadioGroup>
        ...
        <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mt: 1 }}>
          {config.keepMode
            ? t('wordFrequency.posFilter.keepModeDesc')
            : t('wordFrequency.posFilter.filterModeDesc')
          }
        </Typography>
      </AccordionDetails>
    </Accordion>
