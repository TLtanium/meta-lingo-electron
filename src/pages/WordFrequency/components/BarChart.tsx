 ...
 * Horizontal bar chart for word frequency visualization
 */
...
export default function BarChart({
    ...
    g.selectAll('.bar')
      ...
      .on('mouseover', function(event, d) {
        ...
        const tooltip = g.append('g')
          .attr('class', 'tooltip')
          .attr('transform', `translate(${xScale(showPercentage ? d.percentage : d.frequency) + 5}, ${(yScale(d.word) || 0) + yScale.bandwidth() / 2})`)
  ...
  }, [data, maxItems, dimensions, colorScheme, showPercentage, onBarClick])
